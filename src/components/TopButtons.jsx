  ...
  <div className="flex flex-wrap justify-center gap-2 mb-5">
    {CITIES.map((city) => (
      <button
        ...
        className="group relative flex items-center gap-2 px-4 py-2 font-barlow text-xs tracking-[0.2em] uppercase
          bg-[#0a0806] border border-[#f0c030]/20 text-[#f0c030]/50
      ...
      >
        ...
        <span>{city.code}</span>
        <span className="absolute top-0 left-0 w-2 h-2 border-t-2 border-l-2 border-[#f0c030]/30 group-hover:border-[#f0c030]" />
        <span className="absolute bottom-0 right-0 w-2 h-2 border-b-2 border-r-2 border-[#f0c030]/30 group-hover:border-[#f0c030]" />
      </button>
    ))}
  </div>
);
